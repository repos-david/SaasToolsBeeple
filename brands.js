/* ================================================================
   ...
   Each entry:
     match          – RegExp tested against the tenant hostname (lowercase)
   ...
   Call applyBrand(tenantBaseUrl) after the DOM is ready.
   Call it again whenever the theme changes.
   ================================================================ */
...
function applyBrand(base) {
  ...
  // Reset previous brand overrides
